...
function modifyMacMachineId() {
  try {
    ...
    const newDevDeviceId = generateRandomDevDeviceId()
    const newMacMachineId = generateRandomMacMachineId()
...
function generateRandomDevDeviceId() {
...
function generateRandomMacMachineId() {
  return 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'.replace(
    /[x]/g,
    function () {
      return ((Math.random() * 16) | 0).toString(16)
